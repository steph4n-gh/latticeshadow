...
| M5 | Portable recovery preserves canonical fields in fresh guest without source key; failures leave old vault usable | Current `20669ff` ZIP [fresh-guest restore](validation/packaged-app-20669ff-2026-09-23.md) reopened a `b603442`-exported archive with matching canonical fields and tombstone; wrong passphrase left no destination and good restore usable. Full export/restore was also checked on the [preceding app](validation/mini-b603-packaged-2026-09-23.md). | Current cross-version restore passed; current export pending |
